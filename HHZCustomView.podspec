#
#  Be sure to run `pod spec lint HHZCustomView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "陈哲是个好孩子-HHZCustomView"

  s.homepage     = "https://github.com/chenzhe555/HHZCustomView"
  ...
  s.source       = { :git => "https://github.com/chenzhe555/HHZCustomView.git", :tag => "#{s.version}" }
